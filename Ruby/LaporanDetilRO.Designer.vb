...
Partial Public Class LaporanDetilRO
    ...
    Private Sub InitializeComponent()
        ...
        'PageHeader
        '
        Me.PageHeader.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.lbAlamat, Me.XrTable1, Me.XrLabel1, Me.lbCompany})
