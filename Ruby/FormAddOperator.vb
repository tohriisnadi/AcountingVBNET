Public Class FormAddOperator
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        ElseIf txtPasword1.Text <> txtPasword2.Text Then
            ...
            txtPasword2.Focus()
        Else
            dataOperator.addOperator(txtNama.Text, txtPasword1.Text)
    ...
    Private Sub FormAddOperator_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Show()
        txtNama.Focus()
    End Sub
End Class